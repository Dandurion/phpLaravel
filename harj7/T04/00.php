 ...
 *
 * PHP-ohjelma, joka tarjoaa kayttoliittyman tietyssa web-kansiossa sijaitsevien 
 * PHP-ohjelmien syntaksin korostamiseen web-sivulla.
 *
 * Kayttaa syntaksin korostukseen:
...
// jos seurattu linkkia ja kansiossa oleva tiedosto kasilla:
...
if (!$found) echo "<li>Tassa kansiossa ei ole tiedostoja paatteilla: $file_extensions!\n";
echo "</ul>";
}
?>
