...
<div class="container">
    <div class="row">
        ...
        <h2 id="uploadhead">Uuden opiskelijan lisääminen tietokantaan</h2>
        <p>Kirjoita tiedot huolellisesti(tai ei)</p>
        <hr/>
            <form role="form" data-toggle="validator" method="POST" action="{{ url('/storestudent') }}" style="width: 80%; margin: 0 auto; ">
